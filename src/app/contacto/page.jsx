        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-xl text-white/85 max-w-3xl mx-auto">
              Conéctate con nuestro equipo especializado en soluciones tecnológicas para el sector salud. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {/* WhatsApp Médico */}
                <div className="rounded-3xl ring-1 ring-white/10 bg-white/5 backdrop-blur-md p-6 shadow-xl transition hover:scale-105 hover:ring-blue-400/40">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold">WhatsApp Médico</h3>
                      <p className="text-white/80">+56 9 7788 9900</p>
                      <a
                        href="https://wa.me/56977889900?text=Hola,%20me%20interesa%20conocer%20las%20soluciones%20médicas%20de%20Medify"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center mt-2 text-sm text-blue-400 hover:text-blue-300 transition"
                      >
                        Escribir mensaje
                      </a>
                    </div>
                ...
                <div className="rounded-3xl ring-1 ring-white/10 bg-white/5 backdrop-blur-md p-6 shadow-xl transition hover:scale-105 hover:ring-blue-400/40">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="text-white font-semibold">Email Comercial</h3>
                      <p className="text-white/80">ventas@medify.healthcare</p>
                      <a
                ...
                <div className="rounded-3xl ring-1 ring-white/10 bg-white/5 backdrop-blur-md p-6 shadow-xl transition hover:scale-105 hover:ring-blue-400/40">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80">soporte@medify.healthcare</p>
                      <a
              ...
              <form className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      type="text"
                      className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition"
                  ...
                  <div>
                    ...
                    <select className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition">
                ...
                <div>
                  ...
                  <textarea
                    rows={4}
                    className="w-full px-4 py-3 rounded-xl bg-white/10 border border-white/20 text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition resize-none"
          ...
          <div className="mt-16 text-center">
            <div className="rounded-3xl ring-1 ring-white/10 bg-gradient-to-r from-blue-500/20 to-teal-600/20 backdrop-blur-md p-8 shadow-xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="/servicios"
                  className="inline-flex items-center justify-center px-6 py-3 bg-white/10 text-white font-semibold rounded-xl border border-white/20 hover:bg-white/20 transition duration-300"
                >
                  Ver Soluciones
                </a>
              </div>
