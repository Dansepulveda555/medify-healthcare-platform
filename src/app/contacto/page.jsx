...
export default function Contacto() {
  return (
    <div>
      ...
      <div className="md:relative min-h-screen py-24 px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                {/* WhatsApp Médico */}
                <div className="rounded-3xl ring-1 ring-white/10 bg-white/5 backdrop-blur-md p-6 shadow-xl transition hover:scale-105 hover:ring-[#4a8da7]/40">
                ...
                <div className="rounded-3xl ring-1 ring-white/10 bg-white/5 backdrop-blur-md p-6 shadow-xl transition hover:scale-105 hover:ring-[#4a8da7]/40">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80">ventas@medify.cl</p>
                      <a
                ...
                <div className="rounded-3xl ring-1 ring-white/10 bg-white/5 backdrop-blur-md p-6 shadow-xl transition hover:scale-105 hover:ring-[#4a8da7]/40">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-white/80">soporte@medify.cl</p>
                      <a
